...
def generate_testing_results(
    train_args, logger, predictions, test_dataset, for_nested_ner=False
):
    ...
    with open(
        join(train_args.output_dir, "CMeEE_test.json"), "w", encoding="utf8"
    ) as f:
...
def main(_args: List[str] = None):
    ...
    if train_args.do_predict:
        ...
        generate_testing_results(
            train_args, logger, predictions, test_dataset, for_nested_ner=for_nested_ner
        )

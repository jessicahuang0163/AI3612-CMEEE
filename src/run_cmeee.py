...
from model import BertForCRFHeadNER, BertForLinearHeadNER,  BertForLinearHeadNestedNER, BertForCRFHeadNestedNER, BertForBiLSTMHeadNestedNER, CRFClassifier, LinearClassifier, BiLSTMClassifier
...
def main(_args: List[str] = None):
    ...
    if train_args.do_predict:
        ...
        generate_testing_results(train_args, logger, predictions, test_dataset, title='CMeEE_test.json', for_nested_ner=for_nested_ner)
